...
namespace App\Http\Controllers\Backend\UserManagement\User;
...
class UserController extends Controller
{
	...
	public function getUserRole(Request $request){
		$this->userService->getUserRole($request);
	}

    public function index(){
    	$data['user'] = $this->userService->getAll();
    ...
    {
        $data['editData']   = $this->userService->getByID($id);
    ...
    {
        $this->userService->userStatus($request);
