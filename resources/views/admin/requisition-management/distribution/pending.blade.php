                        ...
                        <div class="card-body">
                            ...
                            <table id="sb-data-table" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($pendingDistributes as $list)
                                        @php
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @if (sorpermission('admin.distribution.distribute'))
                                                    <a class="btn btn-sm btn-success" href="{{ route('admin.distribution.distribute.edit', $list->id) }}">
