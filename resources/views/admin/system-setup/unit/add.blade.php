                ...
                <div class="col-lg-12">
                    <div class="card shadow-sm">
                        <div class="card-header text-right">
                            ...
                            <a href="{{ route('admin.unit.list') }}" class="btn btn-sm btn-info"><i class="fas fa-list mr-1"></i>ইউনিটের তালিকা</a>
                        </div>
                        <div class="card-body">
                            <form id="submitForm" action="{{ isset($editData) ? route('admin.unit.update', $editData->id) : route('admin.unit.store') }} " method="post" enctype="multipart/form-data" autocomplete="off">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-row">
                                            <div class="form-group col-sm-6">
                                                <label class="control-label">ইউনিট <span class="text-red">*</span>
                                                </label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="text-right">
                                            ...
                                            <button type="button" class="btn btn-default btn-sm ion-android-arrow-back">
                                                <a href="{{ route('admin.unit.list') }}">পিছনে যান</a>
                                            </button>
                                        </div>
                                    </div>
                            </form>
