...
Route::prefix('/employee-designation')->group(function () {
    ...
    Route::post('/store', [DesignationController::class, 'store'])->name('employee.designation.store');
    Route::get('/edit/{id}', [DesignationController::class, 'edit'])->name('employee.designation.edit');
    Route::post('/update/{id}', [DesignationController::class, 'update'])->name('employee.designation.update');
    Route::post('/delete', [DesignationController::class, 'delete'])->name('employee.designation.delete');
});
